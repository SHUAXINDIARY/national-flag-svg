...
function drawAsFlag() {
  ...
  drawBlankFlag(flag, "#243f78", "#1b2c56");
  roughCanvas.polygon(
    [[mapFlagX(0, 0, flagBox), mapFlagY(0, 0, flagBox)], fly, [mapFlagX(0, 1, flagBox), mapFlagY(0, 1, flagBox)]],
    { stroke: "#8f2633", strokeWidth: 9, fill: "#fbfdfa", fillStyle: "solid", roughness: 2.2, bowing: 1.2 },
  );
